      ...
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center">
          ...
          <div className='flex gap-4'>
            <button
              className='bg-electric-blue hover:translate-y-[-5px]  hover:duration-300 ease-in-out text-black rounded-lg px-1 py=1 md:px-6 md:py-3 text-lg font-semibold hover:bg-gray-200 transition'
              onClick={scrollToTuvoliWidget}
            >
              JET CHARTER QUOTE
            </button>
            <Link href="/company/contact">
              <button className='bg-electric-blue  hover:translate-y-[-5px]  hover:duration-300 ease-in-out text-black rounded-lg px-1 py-1 md:px-6 md:py-3 text-lg font-semibold hover:bg-red-700 transition'>
                CONTACT US
              </button>
            </Link>
          </div>
