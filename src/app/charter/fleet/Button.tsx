...
const Button = () => {
  return (
    <div>
      <button className="flex items-center px-8 py-4 mt-10 bg-white border border-gray-500 rounded-xl shadow-sm hover:bg-red-600 group focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
