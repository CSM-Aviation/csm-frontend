...
const AnimatedCSMVideoText = ({ videoSource }: { videoSource: string }) => {
  ...
  return (
    <>
      ...
      <div style={{top:0, left:0}} className="relative w-full max-sm:h-[70vh] h-screen flex items-center justify-center pt-24" ref={containerRef}>
        ...
        >
          ...
          <div className='w-full absolute top-1/3 md:top-[50%] lg:top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 mt-16'>
            <svg 
          ...
          <motion.div 
            className="absolute sm:top-[60%] md:top-[72%] lg:top-[64%] xl:top-[62%] text-white text-xl md:text-2xl text-center font-light w-full"
            variants={{
          ...
          <motion.div className="absolute sm:top-[65%] md:top-[80%] lg:top-[70%] xl:top-[67%] text-white text-xl md:text-2xl text-center font-light w-full">
            <JetInsightComponent/>
          </motion.div>
        </motion.div>
      </div>
