...
const AnimatedCSMVideoText = ({ videoSource }) => {
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center bg-black" ref={containerRef}>
      ...
      {/* SVG mask for the text with animation */}
      <motion.div 
        className="relative w-full max-w-6xl h-screen flex items-center justify-center overflow-hidden"
        initial="hidden"
      ...
      >
        ...
        >
          <defs>
            {/* Create letter masks individually for animation */}
            <mask id="mask-c">
          ...
          <motion.g variants={letterVariants}>
            <foreignObject x="30" y="50" width="230" height="300" mask="url(#mask-c)">
          ...
          {/* Animated letter S */}
          <motion.g variants={letterVariants}>
            <foreignObject x="260" y="50" width="240" height="320" mask="url(#mask-s)">
              <div className="w-full h-full overflow-hidden">
                {videoSource && (
                  <video 
                    className="w-full h-full object-cover"
          ...
          {/* Animated letter M */}
          <motion.g variants={letterVariants}>
            <foreignObject x="550" y="50" width="260" height="300" mask="url(#mask-m)">
              <div className="w-full h-full overflow-hidden">
                {videoSource && (
                  <video 
                    className="w-full h-full object-cover"
          ...
          {/* Animated "AVIATION" text */}
          <motion.g variants={letterVariants}>
            <foreignObject x="350" y="380" width="500" height="100" mask="url(#mask-aviation)">
              <div className="w-full h-full overflow-hidden">
                {videoSource && (
                  <video 
                    className="w-full h-full object-cover"
                    ...
                    playsInline
                    preload="auto"
                    style={{ transform: "scale(2) translateY(-30%)" }}
                  >
                    <source src={videoSource} type="video/mp4" />
                  </video>
                )}
        ...
        <motion.div 
          className="absolute bottom-16 text-white text-xl md:text-2xl text-center font-light"
          variants={{
