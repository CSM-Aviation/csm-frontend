    ...
    <div className="w-full">
      ...
      <div className="relative h-screen">
        ...
        <motion.h1 
            ...
            transition={{ duration: 0.8 }} className="text-5xl md:text-6xl font-bold text-red-700 mb-4">AIRCRAFT MAINTENANCE  </motion.h1>
        <motion.p 
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }} className="text-xl md:text-2xl text-white">
