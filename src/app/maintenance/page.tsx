    ...
    <div className="w-full">
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-start px-4 md:px-16">
          <h1 className="text-5xl md:text-6xl font-bold text-red-700 mb-4">AIRCRAFT MAINTENANCE</h1>
      ...
      <div className='w-full bg-gray-400 py-12'>
      ...
      <div className='w-full py-16 bg-gray-100'>
        <div className='container mx-auto px-4 flex flex-col items-center justify-center text-center max-w-2xl'>
          ...
          <button className='bg-blue-500 text-white px-6 py-3 rounded-full hover:bg-blue-600 transition duration-300 text-lg'>
            MAINTENANCE INQUIRY
          </button>
        </div>
      </div>
